          ...
          <div className="flex items-center justify-center">
            <div className="mt-[80px] max-w-[688px] w-full flex ">
              <input
                type="email"
                required
                className="py-[15px] px-[20px] outline-none rounded-tl-[5px] rounded-bl-[5px] text-[#737373] bg-white w-full border-l border-t border-b border-solid border-[#e6e6e6]"
